...
## Step 1: Linux bridge acts like a virtual switch
...
## Step 2: VM-1 and VM-2 both connected to br0
...
## Step 3: VM-1 sends ARP broadcast
...
## Step 6: Bridge learns VM-1 MAC, adds to FDB
...
## Step 7: VM-1 sends data to VM-2 (unicast)
...
## Step 8: Bridge looks up FDB — forwards to VM-2
...
## Step 9: VM-1 sends to internet (not local)
...
## Step 10: Bridge forwards to router (uplink)
