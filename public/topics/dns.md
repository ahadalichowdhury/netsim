...
## Step 2: PC checks local DNS cache — miss
...
## Step 3: PC builds DNS Query (UDP port 53)
...
## Step 5: Switch forwards to DNS Server
...
## Step 6: DNS Server looks up A record
...
## Step 8: Switch forwards Reply to PC
...
## Step 10: DNS Resolution complete!
