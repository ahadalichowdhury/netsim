...
## Step 1: Linux box connects two networks
...
## Step 2: ip_forward is enabled in kernel
...
## Step 3: Web namespace sends packet to 10.0.0.20
...
## Step 4: Packet reaches br0 (192.168.1.1)
...
## Step 5: Kernel routing table: 10.0.0.0/24 via br1
...
## Step 6: Kernel forwards packet to br1
