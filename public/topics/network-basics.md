...
## Step 1: User initiates a network action
...
## Step 2: Application needs the server's IP address
...
## Step 3: DNS resolves hostname to IP (if needed)
...
## Step 4: Application needs the destination MAC address
...
## Step 5: Same network? Use ARP directly. Different network? Use Gateway.
...
## Step 6: ARP discovers the MAC address
...
## Step 7: Application builds the Ethernet frame
...
## Step 8: NIC transmits the frame onto the wire
