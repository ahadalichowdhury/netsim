...
## Step 1: New PC boots up — no IP address!
...
## Step 2: PC builds DHCP Discover (broadcast)
...
## Step 4: Switch floods to DHCP Server
...
## Step 5: DHCP Server checks IP pool
...
## Step 6: Server builds DHCP Offer
...
## Step 8: Switch forwards Offer to PC
...
## Step 9: PC sends DHCP Request (broadcast)
...
## Step 11: PC configures network interface
