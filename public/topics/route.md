...
## Step 1: Linux box has 2 interfaces, 2 route table entries
...
## Step 2: Packet arrives from PC-A (192.168.1.10)
...
## Step 4: Kernel checks routing table for destination 8.8.8.8
...
## Step 6: Kernel forwards packet to eth1
...
## Step 10: ip route shows the kernel's routing table
