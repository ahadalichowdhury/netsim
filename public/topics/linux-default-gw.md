...
## Step 1: Linux host wants to reach 8.8.8.8
...
## Step 3: No specific route for 8.8.8.8 — use default
...
## Step 4: Default route: via 192.168.1.1 dev eth0
...
## Step 6: eth0 sends to Router (192.168.1.1)
...
## Step 7: Router forwards to Internet
...
## Step 9: Router NAT translates, sends to Host
...
## Step 10: Default gateway routing complete!
